...
const ACCION_LABEL: Record<string, string> = {
  ...
  confirmar_cliente: 'Cliente confirmado',
  invitar_usuario: 'Usuario invitado',
  cambiar_rol_usuario: 'Rol de usuario cambiado',
  eliminar_usuario: 'Acceso de usuario eliminado',
};
...
export default function LogPage() {
  ...
  const [filtroEntidad, setFiltroEntidad] = useState<'todas' | 'pedido' | 'producto' | 'cliente' | 'usuario'>(
    'todas'
  );
    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-4">
        ...
        <div className="flex gap-2 flex-wrap">
          {(['todas', 'pedido', 'producto', 'cliente', 'usuario'] as const).map((valor) => (
            <button
              key={valor}
