      ...
      <div className="relative bg-white rounded-card p-6 w-full max-w-lg max-h-[85vh] overflow-y-auto">
        <div className="flex justify-between items-start mb-4">
          <div className="flex items-center gap-3">
            <div className="w-14 h-14 rounded-card bg-frost-50 border border-frost-100 overflow-hidden shrink-0">
              {cliente.foto_url ? (
                <img src={cliente.foto_url} alt={cliente.nombre_apellido} className="w-full h-full object-cover" />
              ) : (
                <div className="w-full h-full flex items-center justify-center text-frost-300 text-[10px]">
                  Sin foto
                </div>
              )}
            </div>
          ...
          {cliente.maps_url && (
            <p>
              <a
                ...
                className="text-frost-600 underline"
              >
                Ver en Google Maps
              </a>
            </p>
